    ...
    return `
      <div style="padding: 18px 24px; border-bottom: 1px solid #f1f5f9; background: #fff; display: flex; flex-direction: column; gap: 14px;">
        ...
        <div style="display: flex; align-items: center; position: relative; height: 38px;">
          <!-- Left: Remove Button -->
          <button onclick="removeItem(${idx})" style="background: #fff; border: 1px solid #f1f5f9; color: #ef4444; display: flex; align-items: center; gap: 8px; font-size: 0.85rem; padding: 0 16px; border-radius: 10px; height: 100%; cursor: pointer; font-weight: 600; margin-left: auto; position: absolute; left: 0;">
          ...
          <!-- Center: Stepper and Right-of-Center: Discount Button -->
          <div style="display: flex; align-items: center; gap: 12px; margin-right: auto; margin-left: auto;">
